...
public class HomeTop10TrackAdapter extends RecyclerView.Adapter<HomeTop10TrackAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            title = (TextView) view.findViewById(R.id.topten_title);
            artist = (TextView) view.findViewById(R.id.topten_artist);
            thumbnail = (ImageView) view.findViewById(R.id.topten_thumbnail);
    ...
    public HomeTop10TrackAdapter(Context mContext, List<Tracks> tracksList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.home_track_row, parent, false);
